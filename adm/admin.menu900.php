...
$menu["menu900"] = array(
    ...
    array('900000', '커뮤니티관리', '' . G5_Z_URL . '/manager_notice_list.php', 'manager_notice_list'),
    array('900100', '관리자공지사항', '' . G5_Z_URL . '/manager_notice_list.php', 'manager_notice_list'),
    array('900200', '고객공지사항', '' . G5_Z_URL . '/user_notice_list.php', 'user_notice_list'),
    array('900300', 'FAQ', '' . G5_Z_URL . '/platform_faq_group_list.php', 'platform_faq_group_list'),
    array('900400', '설문조사관리', '' . G5_Z_URL . '/servey_list.php', 'servey_list', 1),
    array('900500', '문자보내기', '' . G5_Z_URL . '/mesage_send.php', 'mesage_send', 1),
);
