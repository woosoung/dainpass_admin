...
if ($status_filter !== '') {
    ...
    // status_filter_sql은 shop_settlements 테이블에 직접 적용되므로 별칭 없이 사용
...
try {
    // 주의: 실제 데이터베이스 스키마를 확인하여 테이블명과 컬럼명을 정확히 맞춰야 합니다.
    // 아래 쿼리는 작업지시서의 가정을 바탕으로 작성되었습니다.
