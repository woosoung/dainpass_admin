...
try {
    ...
    // 업종별 평균 평점 - 필터 조건을 JOIN 조건으로 옮겨서 모든 업종 포함
    // 지역 필터 조건을 JOIN 조건에 포함
