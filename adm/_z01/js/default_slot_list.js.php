...
function addSlot() {
    try {
        ...
        document.getElementById('old_category_id').value = '';
...
function editSlot(category_id, weekday, slot_seq, open_time, close_time, is_open) {
    document.getElementById('action').value = 'edit';
    document.getElementById('modalTitle').innerText = '시간대 수정';
    document.getElementById('old_category_id').value = category_id;
...
function deleteSlot(category_id, weekday, slot_seq) {
    ...
    form.method = 'POST';
    form.action = './default_slot_list_update.php';
...
function saveSlot() {
    ...
    var category_id = document.getElementById('modal_category_id').value;
    ...
    submitForm.action = './default_slot_list_update.php';
    ...
    if (document.getElementById('action').value == 'edit') {
        fields['old_category_id'] = document.getElementById('old_category_id').value;
