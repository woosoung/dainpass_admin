...
<form name="form01" id="form01" action="./customer_qa_list_update.php" onsubmit="return form01_submit(this);" method="post">
        ...
        <table class="table table-bordered table-condensed tbl_sticky_100">
            ...
            <tbody>
                ...
                for ($i=0; $row=sql_fetch_array_pg($result->result); $i++){
                    $s_mod = '<a href="./customer_qa_form.php?'.$qstr.'&amp;w=u&amp;qna_id='.$row['qna_id'].'">답변/보기</a>';
                ...
                <tr class="<?=$bg?>" tr_id="<?=$row['qna_id']?>">
                    ...
                    <td class="td_customer_info td_left">
                        <div class="text-sm">
                            ...
                            <div class="text-gray-500 text-xs">ID: <?=$row['customer_id']?></div>
                        </div>
                    </td>
...
<?php include_once('./js/customer_qa_list.js.php'); ?>
<?php
