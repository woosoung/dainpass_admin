...
<div class="local_desc01 local_desc mb-4">
    <p>
        플랫폼 전체 포인트 적립/사용/소멸 통계 및 분석을 조회합니다.
    </p>
</div>
...
<div class="statistics-cards grid gap-4 mb-6" style="grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));">
    ...
    <div class="card border rounded px-4 py-3 bg-white shadow-sm">
        <div class="text-sm text-gray-500 mb-1">총 포인트 소멸량 (누적)</div>
        <div class="text-2xl font-bold mb-1" id="total_expired">-</div>
        <div class="text-xs text-gray-600">전체 기간 소멸량</div>
    </div>
    <div class="card border rounded px-4 py-3 bg-white shadow-sm">
    ...
    <div class="card border rounded px-4 py-3 bg-white shadow-sm">
        <div class="text-sm text-gray-500 mb-1">포인트 소멸률</div>
        <div class="text-2xl font-bold mb-1" id="expiry_rate">-</div>
        <div class="text-xs text-gray-600">소멸량 / 적립량</div>
    </div>
</div>

<!-- 차트 영역: 첫 번째 줄 - 포인트 거래 유형별 분포, 기간별 포인트 적립/사용/소멸 추이 -->
    ...
    <div class="chart-container border rounded p-4 bg-white shadow-sm">
        ...
        <div class="mt-3 text-xs text-gray-600 border-t pt-2">
            ...
            <ul class="list-disc list-inside space-y-1">
                ...
                <li>소멸 비율이 높을수록 만료 기간이나 사용 안내 정책 재검토가 필요합니다.</li>
            </ul>
        </div>
    </div>
    <div class="chart-container border rounded p-4 bg-white shadow-sm">
        <h3 class="mb-2 font-semibold">기간별 포인트 적립/사용/소멸 추이</h3>
        <div style="position: relative; height: 300px;">
        ...
        <div class="mt-3 text-xs text-gray-600 border-t pt-2">
            <p class="mb-1"><strong>해석 방법:</strong></p>
            <ul class="list-disc list-inside space-y-1">
                <li>기간별 포인트 흐름을 분석하여 적립/사용/소멸 패턴을 파악할 수 있습니다.</li>
                <li>적립 추세가 상승하면 플랫폼 활동이 증가하고 있음을 의미합니다.</li>
                <li>사용 추세와 적립 추세를 비교하여 포인트 활용도를 평가할 수 있습니다.</li>
                <li>소멸 패턴을 분석하여 만료 정책의 효과를 확인할 수 있습니다.</li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="chart-container border rounded p-4 bg-white shadow-sm">
        ...
        <div class="mt-3 text-xs text-gray-600 border-t pt-2">
            ...
            <ul class="list-disc list-inside space-y-1">
                ...
                <li>양수 값은 적립량이 사용량과 소멸량을 초과하여 포인트 잔액이 증가했음을 의미합니다.</li>
                <li>음수 값은 사용량과 소멸량이 적립량을 초과하여 포인트 잔액이 감소했음을 의미합니다.</li>
                <li>추세 분석을 통해 포인트 정책의 효과를 평가할 수 있습니다.</li>
            </ul>
        </div>
    </div>
    <div class="chart-container border rounded p-4 bg-white shadow-sm">
...
<!-- 차트 영역: 세 번째 줄 - 가맹점별 포인트 적립 기여도, 회원별 포인트 보유량 순위 -->
<div class="charts-area grid gap-6 mb-6" style="grid-template-columns: minmax(0, 1fr) minmax(0, 1fr);">
    <div class="chart-container border rounded p-4 bg-white shadow-sm">
        <h3 class="mb-2 font-semibold">가맹점별 포인트 적립 기여도 (상위 20개)</h3>
        <div style="position: relative; height: 400px;">
            <canvas id="shop_earned_rank_chart"></canvas>
        </div>
        <div class="mt-3 text-xs text-gray-600 border-t pt-2">
            <p class="mb-1"><strong>해석 방법:</strong></p>
            <ul class="list-disc list-inside space-y-1">
                <li>가맹점별 포인트 적립 기여도를 통해 포인트 적립이 활발한 가맹점을 파악할 수 있습니다.</li>
                <li>상위 가맹점의 특성을 분석하여 다른 가맹점에 적용할 수 있습니다.</li>
                <li>포인트 적립 기여도가 높은 가맹점과 파트너십을 강화할 수 있습니다.</li>
                <li>포인트 시스템 활용도가 낮은 가맹점에 대한 지원 정책을 수립할 수 있습니다.</li>
            </ul>
        </div>
    </div>
    <div class="chart-container border rounded p-4 bg-white shadow-sm">
