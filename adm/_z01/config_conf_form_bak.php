...
<section id="anc_cf_widget">
    <h2 class="h2_frm">Amazon환경설정</h2>
    <?php echo $pg_anchor ?>
    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>아마존환경설정</caption>
        <colgroup>
            <col class="grid_4" style="width:15%;">
            <col style="width:35%;">
            <col class="grid_4" style="width:15%;">
        ...
        <tr>
            ...
            <td colspan="3" class="tms_help">
                ...
                <div class="tms_hint flex gap-6">
                    <input type="text" name="set_aws_region" class="w-[40%]" value="<?=${'set_'.$set_type}['set_aws_region']??''?>">
                    <div class="tms_hbox">
                        <div class="tms_hcon">
        ...
        <tr>
            ...
            <td colspan="3" class="tms_help">
                ...
                <div class="tms_hint flex gap-6">
                    <input type="text" name="set_aws_bucket" class="w-[40%]" value="<?=${'set_'.$set_type}['set_aws_bucket']??''?>">
                    <div class="tms_hbox">
                        <div class="tms_hcon">
