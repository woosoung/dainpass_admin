...
<form name="fcustomerqaform" id="fcustomerqaform" action="./customer_qa_form_update.php" method="post" enctype="multipart/form-data" onsubmit="return fcustomerqaform_submit(this);">
...
<div class="btn_fixed_top">
    ...
    <a href="./customer_qa_list.php?<?php echo $qstr; ?>" class="btn_02 btn">목록</a>
</div>
</form>
...
<?php include_once('./js/customer_qa_form.js.php'); ?>
