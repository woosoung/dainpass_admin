...
if (!isset($qna['qna_id']) || !$qna['qna_id']) {
    alert("문의자료가 없거나 해당 가맹점의 문의가 아닙니다.");
}
...
if ($w == 'r') {
    ...
    $sql = " INSERT INTO shop_qna 
             ...
             VALUES 
             ('{$qna_id}', '{$shop_id}', NULL, '', '".addslashes($qna_reply_content)."', '".addslashes($qna_ip)."', '{$qna_reply_secret_yn}', '".addslashes($reply_mb_id)."', 'pending', NOW(), NOW()) ";
