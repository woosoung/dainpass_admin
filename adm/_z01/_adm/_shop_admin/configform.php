...
<section id="anc_scf_etc" >
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="de_cart_keep_term">리뷰수정유효기간<?php if($is_dev_manager) { ?><br><span class="text-red-800">de_review_modify_period</span><?php } ?></label></th>
            <td>
                 <?php echo help("리뷰수정기간은 리뷰작성일시를 기준으로 계산됩니다."); ?>
                <input type="text" name="de_review_modify_period" value="<?php echo get_sanitize_input($default2['de_review_modify_period']??''); ?>" id="de_review_modify_period" class="frm_input" size="5"> 일
            </td>
        </tr>
        <tr>
